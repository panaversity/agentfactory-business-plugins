...
# ///
"""Innovation Eval Harness -- deterministic routing and content checks.
...
Usage:
    ...
    uv run evals/run.py --case route_idea_generation  # single case
...
# Paths
# ---------------------------------------------------------------------------
ROOT = Path(__file__).resolve().parent.parent  # innovation/ root
...
def main():
    parser = argparse.ArgumentParser(description="Innovation Eval Harness")
    ...
    # Run cases
    print(f"\nInnovation Eval Harness -- {len(cases)} cases", file=sys.stderr)
